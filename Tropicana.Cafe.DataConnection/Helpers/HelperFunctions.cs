...
namespace Tropicana.Cafe.Main.Extensions
{
    public static class HelperFunctions
    {
        ...
        public static BasicMealPeriods GetMealPeriod()
        {
            switch (MealDatabaseAccess.GetBasicMealPeriod())
            {
                case "Breakfast":
                    return BasicMealPeriods.Breakfast;
                case "Lunch":
                    return BasicMealPeriods.Lunch;
                case "Dinner":
                    return BasicMealPeriods.Dinner;
                default:
                    return BasicMealPeriods.Blank;
            }
        }

        public static BasicMealPeriods GetMealPeriod(DateTime now)
        {
            switch (MealDatabaseAccess.GetBasicMealPeriod())
            {
                case "Breakfast":
